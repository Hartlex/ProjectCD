...
namespace SunStructs.Definitions
{
    ...
    public enum TransformType
    {
        ...
        TRANSFORM_TYPE_DRAGON1 = 100,
        TRANSFORM_TYPE_DRAGON2 = 101,
    };

    public enum CharExType
    {
        CHAREX_100LEVEL_CHANGEUP_CONSTANT = 10,
        //
        CHAREX_DRAGON_1stTRANS = TransformType.TRANSFORM_TYPE_DRAGON1,      // µå·¡°ï³ªÀÌÆ® º¯½Å 1Â÷
        CHAREX_DRAGON_2ndTRANS = TransformType.TRANSFORM_TYPE_DRAGON2,      // µå·¡°ï³ªÀÌÆ® º¯½Å 2Â÷

        CHAREX_BERSERKER_100LEVEL = CharType.CHAR_BERSERKER + CHAREX_100LEVEL_CHANGEUP_CONSTANT, // ¹ö¼­Ä¿ 100·¹º§ Ã¼ÀÎÁö¾÷ ÄÚµå
        CHAREX_DRAGON_KNIGHT_100LEVEL = CharType.CHAR_DRAGON + CHAREX_100LEVEL_CHANGEUP_CONSTANT, // µå·¡°ï³ªÀÌÆ® 100·¹º§ Ã¼ÀÎÁö¾÷ ÄÚµå
        CHAREX_SHADOW_100LEVEL = CharType.CHAR_SHADOW + CHAREX_100LEVEL_CHANGEUP_CONSTANT, // ½¦µµ¿ì 100·¹º§ Ã¼ÀÎÁö¾÷ ÄÚµå
        CHAREX_VALKYRIE_100LEVEL = CharType.CHAR_VALKYRIE + CHAREX_100LEVEL_CHANGEUP_CONSTANT, // ¹ßÅ°¸® 100·¹º§ Ã¼ÀÎÁö¾÷ ÄÚµå
        CHAREX_ELEMENTALIST_100LEVEL = CharType.CHAR_ELEMENTALIST + CHAREX_100LEVEL_CHANGEUP_CONSTANT, // ¿¤¸®¸àÅ»¸®½ºÆ® 100·¹º§ Ã¼ÀÎÁö¾÷ ÄÚµå
        CHAREX_MYSTIC_100LEVEL = CharType.CHAR_MYSTIC + CHAREX_100LEVEL_CHANGEUP_CONSTANT, // ¹Ì½ºÆ½ 100·¹º§ Ã¼ÀÎÁö¾÷ ÄÚµå //_NA_004965_20120613_NEW_CHARACTER_MYSTIC
        CHAREX_HELLROID_100LEVEL = CharType.CHAR_HELLROID + CHAREX_100LEVEL_CHANGEUP_CONSTANT, // Çï·ÎÀÌµå 100·¹º§ Ã¼ÀÎÁö¾÷ ÄÚµå //_NA_000000_20130812_NEW_CHARACTER_HELLROID
        CHAREX_WITCHBLADE_100LEVEL = CharType.CHAR_WITCHBLADE + CHAREX_100LEVEL_CHANGEUP_CONSTANT, // À§Ä¡ºí·¹ÀÌµå 100·¹º§ Ã¼ÀÎÁö¾÷ ÄÚµå //_NA_007514_20140828_NEW_CHARACTER_WITCHBLADE

        CHAREX_DRAGON_1stTRANS_100LEVEL = CHAREX_DRAGON_1stTRANS + CHAREX_100LEVEL_CHANGEUP_CONSTANT,
        CHAREX_DRAGON_2ndTRANS_100LEVEL = CHAREX_DRAGON_2ndTRANS + CHAREX_100LEVEL_CHANGEUP_CONSTANT,
    };
